...
def main(file_path, **kwargs):
    ...
    with pd.ExcelWriter(output_excel_path, engine='openpyxl') as writer:
        # Create notes sheet with unit explanations
        notes_data = [
        ...
        notes_df.to_excel(writer, sheet_name='Notes - Units', index=False)
        ...
        for sys, df in technology_data.items():
            ...
            desired_order = ['Notes - Units', 'Global Annual Summary', 'Annualized CAPEX', 'Discounted Costs', 
